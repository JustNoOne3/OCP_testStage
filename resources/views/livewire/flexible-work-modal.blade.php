<x-filament::modal id="modal-fwa" width="5xl">
    ...
    <div class="grid grid-flow-rows">
        ...
        <div class="grid grid-flow-col">
            <x-filament::button wire:click="fwa" color="primary" size="xl" outlined style="margin: 15px;">
                <div class="grid grid-flow-rows">
            ...
            <x-filament::button wire:click="fwa_table" color="primary" size="xl" outlined style="margin: 15px;">
                <div class="grid grid-flow-rows">
