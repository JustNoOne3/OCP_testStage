<x-filament::modal id="modal-cnpc" width="5xl">
    <x-slot name="trigger" class="cnpc-cont" style="width: full;">
        <x-filament::button color="success" size="" outlined style="margin: 15px; width: full; height: auto; padding-left: 50px; padding-right: 50px;">
            <div class="grid grid-flow-rows">
                <img src="{{asset('images/mtpr-1.png')}}" alt="" class="mr-2 mx-auto" style="width: 400px; height: auto;">
            </div>
        </x-filament::button>
    </x-slot>
    ...
    <div class="grid grid-flow-rows">
        ...
        <div class="grid grid-flow-col" style="width: full;">
            <x-filament::button wire:click="mtprf_submit" color="primary" size="2xl" outlined style="margin: 15px; width: 100%; height: full;">
                <div class="grid grid-flow-rows">
            ...
            <x-filament::button wire:click="mtprf_table" color="primary" size="xl" outlined style="margin: 15px;">
                <div class="grid grid-flow-rows">
